...
describe('API Tests', function () {
    ...
    describe('## Items ', function () {
        it('should create a item with default values with audio type', function (done) {
    ...
    describe('# Items', function () {
        it('should get a item with default values with audio type using id', function (done) {
